...
<head>
    ...
    <meta name="description" content="OmniFood is a fabricated premium food delivery service with the mission to bring affordable and healthy meals to as many people as possible.">
    ...
    <header>
        <nav>
            <div class="row">
                ...
                <a class="mobile-nav-icon js--nav-icon" id="menu-icon"><ion-icon name="menu-outline"></ion-icon></a>
            </div>
        </nav>
        ...
        <div class="row">
            <div class="col span-1-of-3">
                <blockquote>
                    ...
                    <cite><img src="resources/img/customer-1.jpg" alt="Profile photo"/>Alberto Duncan</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
                <blockquote>
                    Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Omifood. Me and my family are so in love!
                    <cite><img src="resources/img/customer-2.jpg" alt="Profile photo" />Joana Silva</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
                <blockquote>
                    ...
                    <cite><img src="resources/img/customer-3.jpg" alt="Profile photo" />Milton Chapman</cite>
                </blockquote>
            </div>
        </div>
    </section>
